...
//******************************************************************************
//* STORAGE ELEMENT :: CONSTRUCTOR
//******************************************************************************/
StorageElement::StorageElement() : pt(Position(0.0, 0.0)),
v(Velocity(0.0, 0.0)), radius(0.0), points(0), value(0),
type(StorageType::NONE), age(0.0), size(0.0), timeToDie(0),
ptEnd(Position(0.0, 0.0)), dead(false), angle(0.0), 
pLogElement(nullptr), pIfaceElement(nullptr)
{
}

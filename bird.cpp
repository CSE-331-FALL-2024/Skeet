 ...
 ******************************************************************/
 ...
 // AFTER
Standard::Standard(Status* pScore, Status* pHitRatio, double radius, double speed, int points) :
	Bird(pScore, pHitRatio) {
 ...
 ******************************************************************/
 ...
 // AFTER
Floater::Floater(Status* pScore, Status* pHitRatio, double radius, double speed, int points) :
	Bird(pScore, pHitRatio) {
 ...
 ******************************************************************/
 ...
 // AFTER
Sinker::Sinker(Status* pScore, Status* pHitRatio, double radius, double speed, int points) :
	Bird(pScore, pHitRatio) {
 ...
 ******************************************************************/
 ...
 // AFTER
Crazy::Crazy(Status* pScore, Status* pHitRatio, double radius, double speed, int points) :
	Bird(pScore, pHitRatio) {

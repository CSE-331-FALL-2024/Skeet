 ...
 ******************************************************************/
Standard::Standard(double radius, double speed, int points, Interface* iface, Logic* logic) : Bird()
{
    this->pLogElement = &logic->logStandard;
    this->pIfaceElement = &iface->ifaceStandard;
 ...
 * FLOATER constructor
 ******************************************************************/
Floater::Floater(double radius, double speed, int points, Interface* iface, Logic* logic) : Bird()
{
    this->pLogElement = &logic->logFloater;
    this->pIfaceElement = &iface->ifaceFloater;
 ...
 * SINKER constructor
 ******************************************************************/
Sinker::Sinker(double radius, double speed, int points, Interface* iface, Logic* logic) : Bird()
{
    this->pLogElement = &logic->logSinker;
    this->pIfaceElement = &iface->ifaceSinker;
 ...
 * CRAZY constructor
 ******************************************************************/
Crazy::Crazy(double radius, double speed, int points, Interface* iface, Logic* logic) : Bird()
{
    this->pLogElement = &logic->logCrazy;
    this->pIfaceElement = &iface->ifaceCrazy;
